                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form method="post" id="insert_form" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <input type="file" class="form-control-file" name="upload" id="files" accept="image/*" onchange="previewImage();" aria-describedby="inputGroupFileAddon01">
                                    </div>
                                    <div class="form-group">
...
<script>
    ...
    function load_notifTambah(nrp, nama, password, upassword, sks, file) {
        $.ajax({
            method: "POST",
            url: "process.php?act=tambahMhs",
            data: {
                nrp: nrp, nama: nama, password: password, upassword: upassword, sks: sks, file: file
            },
    ...
    $(document).ready(function() {
        ...
        $('#btnSimpan').click(function() {
            ...
            var sks = $("#sks").val();
            var file = $("#file").val();
            const files = $('#files').prop('files')[0];
            //var data = new FormData();
            //var file = data.append("#file", $(field)[0].files[0])
            alert(file);
            console.log(file);
            load_notifTambah(nrp, nama, password, upassword, sks, file);
            console.log('berhasil key');
            alert(files);
        });
    });
